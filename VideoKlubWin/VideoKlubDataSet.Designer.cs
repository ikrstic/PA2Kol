...
namespace VideoKlubWin {
    ...
    public partial class VideoKlubDataSet : global::System.Data.DataSet {
        ...
        public partial class ClanDataTable : global::System.Data.TypedTableBase<ClanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClanRow AddClanRow(string Ime, string Prezime, string Jmbg, string Adresa, string Telefon) {
        ...
        public partial class ClanRow : global::System.Data.DataRow {
            ...
            public string Jmbg {
                get {
                    return ((string)(this[this.tableClan.JmbgColumn]));
                }
                set {
                    this[this.tableClan.JmbgColumn] = value;
                }
            }
...
namespace VideoKlubWin.VideoKlubDataSetTableAdapters {
    ...
    public partial class ClanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Clan] WHERE (([ClanID] = @Original_ClanID) AND ([Ime] = @Origi" +
                "nal_Ime) AND ([Prezime] = @Original_Prezime) AND ([Jmbg] = @Original_Jmbg) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clan] ([Ime], [Prezime], [Jmbg], [Adresa], [Telefon]) VALUES (" +
                "@Ime, @Prezime, @Jmbg, @Adresa, @Telefon);\r\nSELECT ClanID, Ime, Prezime, Jmbg, A" +
                "dresa, Telefon FROM Clan WHERE (ClanID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clan] SET [Ime] = @Ime, [Prezime] = @Prezime, [Jmbg] = @Jmbg, [Adresa] = @Adresa, [Telefon] = @Telefon WHERE (([ClanID] = @Original_ClanID) AND ([Ime] = @Original_Ime) AND ([Prezime] = @Original_Prezime) AND ([Jmbg] = @Original_Jmbg) AND ([Adresa] = @Original_Adresa) AND ([Telefon] = @Original_Telefon));
SELECT ClanID, Ime, Prezime, Jmbg, Adresa, Telefon FROM Clan WHERE (ClanID = @ClanID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::VideoKlubWin.Properties.Settings.Default.VideoKlubConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClanID, Ime, Prezime, Jmbg, Adresa, Telefon FROM dbo.Clan";
        ...
        public virtual int Delete(int Original_ClanID, string Original_Ime, string Original_Prezime, string Original_Jmbg, string Original_Adresa, string Original_Telefon) {
        ...
        public virtual int Update(string Ime, string Prezime, string Jmbg, string Adresa, string Telefon, int Original_ClanID, string Original_Ime, string Original_Prezime, string Original_Jmbg, string Original_Adresa, string Original_Telefon, int ClanID) {
            if ((Ime == null)) {
                throw new global::System.ArgumentNullException("Ime");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_ClanID));
            if ((Original_Ime == null)) {
                throw new global::System.ArgumentNullException("Original_Ime");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(ClanID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Ime, string Prezime, string Jmbg, string Adresa, string Telefon, int Original_ClanID, string Original_Ime, string Original_Prezime, string Original_Jmbg, string Original_Adresa, string Original_Telefon) {
            return this.Update(Ime, Prezime, Jmbg, Adresa, Telefon, Original_ClanID, Original_Ime, Original_Prezime, Original_Jmbg, Original_Adresa, Original_Telefon, Original_ClanID);
        }
    }
