    ...
    public partial class StudentiDataSet : global::System.Data.DataSet {
        ...
        public partial class PredmetDataTable : global::System.Data.TypedTableBase<PredmetRow> {
            ...
            private void InitClass() {
                ...
                this.columnProfesor.MaxLength = 35;
            }
...
namespace Vezba___Diskonektovan.StudentiDataSetTableAdapters {
    ...
    public partial class PredmetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Predmet] WHERE (([PredmetID] = @Original_PredmetID) AND ([Nazi" +
                "v] = @Original_Naziv) AND ([Profesor] = @Original_Profesor))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Predmet] SET [PredmetID] = @PredmetID, [Naziv] = @Naziv, [Profesor] = @Profesor WHERE (([PredmetID] = @Original_PredmetID) AND ([Naziv] = @Original_Naziv) AND ([Profesor] = @Original_Profesor));
SELECT PredmetID, Naziv, Profesor FROM Predmet WHERE (PredmetID = @PredmetID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Vezba___Diskonektovan.Properties.Settings.Default.StudentiConnectionString;
        }
        ...
        public virtual int Delete(int Original_PredmetID, string Original_Naziv, string Original_Profesor) {
        ...
        public virtual int Update(int PredmetID, string Naziv, string Profesor, int Original_PredmetID, string Original_Naziv, string Original_Profesor) {
            ...
            if ((Original_Profesor == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Profesor));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Naziv, string Profesor, int Original_PredmetID, string Original_Naziv, string Original_Profesor) {
            return this.Update(Original_PredmetID, Naziv, Profesor, Original_PredmetID, Original_Naziv, Original_Profesor);
        }
    }
